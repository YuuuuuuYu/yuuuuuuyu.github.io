...
### 1. HTTP와의 차이점
![httpAndHttps](https://yuuuuuuyu.github.io/assets/img/posts/https0.png)
...
### 2. 동작 원리
![httpsProcess](https://yuuuuuuyu.github.io/assets/img/posts/https1.png)
...
## TLS (Transport Layer Security) <a href="https://developer.mozilla.org/ko/docs/Glossary/TLS" target="_blank">Link</a>
: 위와 같은 문제로 TLS가 등장했으며, SSL의 취약점을 개선하고 표준으로 자리잡게 되었다.  
다음은 TLS의 버전별 개선사항이다.
![tlsVersion](https://yuuuuuuyu.github.io/assets/img/posts/https2.png)
